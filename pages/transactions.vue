...
async function getResults(page = 1) {
   const { data } = await useApiFetch(`/api/transactions?page=${page}`);
...
<template>
   <div class="w-1/2 flex flex-col gap-4">
      <h1 class="text-3xl">Semua Transaksi</h1>
            ...
            >
               ...
               <tbody>
                  ...
                  >
                     ...
                     <td class="px-6 py-4">Rp.{{ transaction.price }}</td>
                     <td class="px-6 py-4">{{ transaction.payment_amount }}</td>
